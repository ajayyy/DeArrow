...
import Config, { ConfigurationID, ThumbnailFallbackOption, TitleFormatting } from "../config/config";
import { toFirstLetterUppercase, toLowerCaseTitle, toSentenceCase } from "../titles/titleFormatter";
import { SelectOptionComponent } from "./SelectOptionComponent";
import { ToggleOptionComponent } from "./ToggleOptionComponent";
import { getOverrideOptionForConfigID, setOverrideOrOriginal } from "../config/channelOverrides";
...
export const FormattingOptionsComponent = ({
    ...
    React.useEffect(() => {
        if (setTitleFormatting) setTitleFormatting(getOverrideOptionForConfigID(configID ?? null, "titleFormatting")!);
        setShouldCleanEmojis(getOverrideOptionForConfigID(configID ?? null, "shouldCleanEmojis")!);
        setThumbnailFallback(getOverrideOptionForConfigID(configID ?? null, "thumbnailFallback")!);
        setThumbnailFallbackAutogenerated(getOverrideOptionForConfigID(configID ?? null, "thumbnailFallbackAutogenerated")!);
    }, [configID]);
        ...
        <>
            ...
            <SelectOptionComponent
                ...
                onChange={(value) => {
                    ...
                    setOverrideOrOriginal(configID, "titleFormatting", parseInt(value, 10));
                }}
            ...
            <ToggleOptionComponent
                ...
                onChange={(value) => {
                    ...
                    setOverrideOrOriginal(configID, "shouldCleanEmojis", value);
                }}
            ...
            <SelectOptionComponent
                ...
                onChange={(value) => {
                    ...
                    setOverrideOrOriginal(configID, "thumbnailFallback", parseInt(value, 10));
                }}
...

            {
                ...
                <SelectOptionComponent
                    ...
                    onChange={(value) => {
                        ...
                        setOverrideOrOriginal(configID, "thumbnailFallbackAutogenerated", parseInt(value, 10));
                    }}
